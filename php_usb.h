...
ZEND_BEGIN_ARG_INFO_EX(usb_init_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 0)
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_get_device_descriptor_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 1)
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_get_config_descriptor_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 2)
  ZEND_ARG_INFO(0, device)
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_get_active_config_descriptor_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 1)
  ZEND_ARG_INFO(0, device)
ZEND_END_ARG_INFO()
#else /* PHP 4.x */
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_get_config_descriptor_by_value_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 2)
  ZEND_ARG_INFO(0, device)
  ZEND_ARG_INFO(0, configuration_value)
ZEND_END_ARG_INFO()
#else /* PHP 4.x */
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_get_string_descriptor_ascii_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 2)
  ZEND_ARG_INFO(0, device)
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_get_descriptor_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 3)
  ZEND_ARG_INFO(0, device_handle)
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_get_string_descriptor_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 3)
  ZEND_ARG_INFO(0, device_handle)
  ZEND_ARG_INFO(0, desc_index)
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_get_device_list_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 1)
  ZEND_ARG_INFO(0, context)
ZEND_END_ARG_INFO()
#else /* PHP 4.x */
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_open_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 1)
  ZEND_ARG_INFO(0, device)
ZEND_END_ARG_INFO()
#else /* PHP 4.x */
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_get_configuration_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 1)
  ZEND_ARG_INFO(0, device_handle)
ZEND_END_ARG_INFO()
#else /* PHP 4.x */
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_control_transfer_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 7)
  ZEND_ARG_INFO(0, device_handle)
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_bulk_transfer_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 4)
  ZEND_ARG_INFO(0, device_handle)
  ZEND_ARG_INFO(0, endpoint)
#if (PHP_MINOR_VERSION > 0)
  ZEND_ARG_ARRAY_INFO(1, data, 1)
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_interrupt_transfer_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 4)
  ZEND_ARG_INFO(0, device_handle)
  ZEND_ARG_INFO(0, endpoint)
#if (PHP_MINOR_VERSION > 0)
  ZEND_ARG_ARRAY_INFO(1, data, 1)
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(usb_set_debug_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 2)
  ZEND_ARG_INFO(0, context)
  ZEND_ARG_INFO(0, level)
ZEND_END_ARG_INFO()
#else /* PHP 4.x */
#define usb_set_debug_arg_info NULL
#endif
